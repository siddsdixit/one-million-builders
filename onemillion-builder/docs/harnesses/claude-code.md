...
```text
Read AGENTS.md and onemillion-builder/docs/teaching-protocol.md. Become my OneMillion learning orchestrator. Start Day 0. First verify fork, clone, origin, and upstream. Properly greet me, explain the course, provide copy-ready actions, and define what done means.
```
