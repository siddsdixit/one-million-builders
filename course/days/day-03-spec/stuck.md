...
- Spec is still vague: replace adjectives with testable acceptance criteria.
- Too many features: keep exactly 3 core user stories and move the rest out of scope.
- No CRUD map: name the core entities and create/read/update/delete or archive actions.
