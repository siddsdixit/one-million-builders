...
- [ ] Starred `siddsdixit/one-million-builders`
- [ ] Forked `siddsdixit/one-million-builders` into your own GitHub account
...
2. Open the course repo: https://github.com/siddsdixit/one-million-builders
3. Click **Star**.
4. Fork directly: https://github.com/siddsdixit/one-million-builders/fork
...
Course: https://github.com/siddsdixit/one-million-builders
...
- A screenshot of `https://github.com/siddsdixit/one-million-builders` open in your browser
