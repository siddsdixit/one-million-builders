...
## Common Day 15 Issues

- Build/test fails: decide whether it is a production blocker or a documented MVP risk.
- AI examples are inconsistent: define pass/fail examples and a threshold.
- Live critical path differs from local: debug production env vars and deployment branch.
