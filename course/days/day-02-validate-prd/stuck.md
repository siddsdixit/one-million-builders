...
```text
I am on OneMillion Day 2: Validate The PRD.
I am stuck.
...
- Validation is only compliments: ask about past behavior and specific recent examples.
- No interviews yet: record serious outreach attempts and schedule follow-ups.
- Competitors are missing: include spreadsheets, manual processes, and generic tools as workarounds.
