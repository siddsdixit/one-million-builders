...
- Architecture is overbuilt: default to Next.js + Supabase unless the plan justifies more.
- Tenancy is unclear: choose single-user, organization/team, or public/community data explicitly.
- Sprints are too large: split into small contracts that can be finished and verified.
