...
## Common Day 14 Issues

- A secret appears in git history: rotate it; deletion alone is not enough.
- Authorization is only in the UI: enforce it server-side and with RLS.
- AI receives too much data: reduce context to the minimum needed.
