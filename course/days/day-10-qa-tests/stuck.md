...
## Common Day 10 Issues

- No test framework exists: complete manual QA and add only the smallest useful automated check.
- Tests fail for setup reasons: record the command, failure, and smallest fix.
- QA is too shallow: include auth, data, permissions, live URL, and edge cases.
