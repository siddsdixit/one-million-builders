...
- Design is generic: tie layout, copy, and density to the target user.
- States are missing: add loading, empty, error, partial, full, and success states.
- Mockup feels fake: use realistic seed data from the product domain.
