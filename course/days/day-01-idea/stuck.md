...
```text
I am on OneMillion Day 1: Idea Agent + PRD Draft.
I am stuck.
...
- Idea is too broad: narrow it to one target user and one painful moment.
- The PRD sounds AI-written: edit it until it sounds like your product.
- No data source is named: identify what the product reads, stores, or asks the user to enter.
