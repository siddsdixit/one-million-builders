...
- Review finds many issues: classify blockers separately from deferrals.
- The UI works but feels wrong: compare it to the target user's original pain.
- Spec drift is intentional: update the spec or record the reason before continuing.
