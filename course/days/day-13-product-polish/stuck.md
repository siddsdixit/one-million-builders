...
## Common Day 13 Issues

- Product technically works but feels confusing: improve copy, hierarchy, and next action first.
- AI output has no recovery path: add retry, edit/review, and failure copy.
- Mobile layout breaks: inspect small viewport before moving on.
