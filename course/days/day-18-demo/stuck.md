...
```text
I am on OneMillion Day 18: Demo Day + Builder Claim.
I am stuck.
...
## Common Day 18 Issues

- Demo is too long: use the 30s/90s/2m/30s/30s structure.
- Loom is private: test it in incognito before submitting.
- Builder Claim is incomplete: include repo, live URL, Loom URL, and product summary.
