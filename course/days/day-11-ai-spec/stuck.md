...
## Common Day 11 Issues

- AI feature is vague: define input, allowed context, output, and measurable pass/fail criteria.
- Tool calling sounds exciting but unnecessary: skip it unless the product needs app data/actions.
- Privacy boundary is missing: name exactly what data AI may receive.
- Redaction is vague: list the fields or topics that must be removed before AI sees the input.
- AI action is too powerful: make output draft-only until a human approves save, send, schedule, or action.
